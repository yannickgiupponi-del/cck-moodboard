  ...
  return (
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 24, marginBottom: 40 }}>
        <ConceptCard
          icon="🎪"
          title="Le Cirque Maudit"
          description="Un cirque ambulant qui s'est installé dans votre ville et ne veut plus partir. Les attractions tournent encore, mais les artistes ont… changé. L'espace physique est un chapiteau permanent, pas un bunker."
          keywords={["Chapiteau", "Attractions détraquées", "Manèges", "Guirlandes", "Confettis noirs"]}
        />
        <ConceptCard
          icon="🃏"
          title="Le Maître du Jeu"
          description="Le Tueur n'est pas un monstre — c'est un showman. Un Maître de Cérémonie qui a décidé que VOUS êtes le spectacle. Il est théâtral, flamboyant, presque charmant. C'est ce qui le rend effrayant."
          keywords={["Showman", "Théâtral", "Charismatique", "Imprévisible", "Performer"]}
        />
        <ConceptCard
          icon="⚡"
          title="Le Jeu avant la Peur"
          description="Chaque élément visuel doit donner envie de jouer. Les affiches sont des invitations, pas des avertissements. Le logo fait sourire nerveusement, pas fuir. L'énergie est celle d'un parc à thème, pas d'un film d'horreur."
          keywords={["Excitation", "Défi", "Énergie", "Social", "Rejouabilité"]}
        />
      </div>
    ...
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 32, marginBottom: 40 }}>
        <div>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            {[
              ...
              { hex: "#1a3a6a", name: "Bleu sombre" },
              { hex: "#8a1a1a", name: "Rouge sang" },
              { hex: "#f0e8d8", name: "Crème" },
            ].map((c) => (<ColorSwatch key={c.hex} {...c} />))}
          </div>
        ...
        <div>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            {[
              { hex: "#0c0c14", name: "Noir nuit" },
              { hex: "#e84040", name: "Rouge cirque" },
              { hex: "#3070e8", name: "Bleu électrique" },
              { hex: "#f0a030", name: "Or forain" },
              { hex: "#c840d8", name: "Violet néon" },
              { hex: "#f0e8d8", name: "Crème chaud" },
            ].map((c) => (<ColorSwatch key={c.hex} {...c} />))}
          </div>
    ...
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 32, marginBottom: 40 }}>
        <Card accent="#e84040" title="❌ Avant : Gothique Médiéval">
          <div style={{ fontSize: 36, fontFamily: "Georgia, 'Times New Roman', serif", fontWeight: 700, color: "#f0e8d8", fontStyle: "italic", margin: "16px 0", letterSpacing: 2 }}>
            Cache Cache Killer
          </div>
          <p style={{ color: "#888", fontSize: 13, lineHeight: 1.6 }}>
            La typographie gothique/médiévale actuelle évoque le Moyen-Âge, le dark fantasy,
            les jeux de rôle sombres. C'est élégant mais froid, et ça ne dit ni "cirque" ni "fun".
            Les diamants et le croissant de lune renforcent un univers mystique qui n'est pas le vôtre.
          </p>
        </Card>
        <Card accent="#f0a030" title="✦ Après : Carnival Display Bold">
          <div style={{ fontSize: 38, fontFamily: "'Impact', 'Arial Black', sans-serif", fontWeight: 900, color: "#f0e8d8", margin: "16px 0", letterSpacing: 3, textTransform: "uppercase", textShadow: "0 0 20px rgba(240,160,48,0.3), 2px 2px 0 #e84040" }}>
            CACHE CACHE KILLER
          </div>
          <p style={{ color: "#999", fontSize: 13, lineHeight: 1.6 }}>
            Direction : typographie <strong>bold, large, spectaculaire</strong> inspirée des affiches
            de cirque et de fête foraine. Des lettres qui ont de la personnalité, du volume,
            de l'impact — comme peintes sur un chapiteau. Fun au premier regard, inquiétant au second.
          </p>
        </Card>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 24 }}>
        <div style={{ background: "#141420", borderRadius: 12, padding: 24 }}>
          ...
          <div style={{ fontSize: 28, fontWeight: 900, fontFamily: "'Impact', sans-serif", textTransform: "uppercase", letterSpacing: 2, marginTop: 12, color: "#fff" }}>
            CIRCUS SLAB / DISPLAY
          </div>
          <p style={{ color: "#777", fontSize: 12, marginTop: 12, lineHeight: 1.6 }}>
            Références : Barnum, Showtime, Circus Didot, Playfair Display Black.
            Lettres larges, empattements prononcés ou display bold.
            Peut avoir des déformations subtiles (lettres légèrement de travers, comme peintes à la main).
          </p>
        </div>
        <div style={{ background: "#141420", borderRadius: 12, padding: 24 }}>
          <span style={{ fontSize: 11, color: "#c840d8", letterSpacing: 2 }}>SOUS-TITRES / ACCROCHES</span>
          <div style={{ fontSize: 22, fontWeight: 600, fontFamily: "sans-serif", marginTop: 12, color: "#fff", fontStyle: "italic" }}>
            Condensed Sans Bold Italic
          </div>
          <p style={{ color: "#777", fontSize: 12, marginTop: 12, lineHeight: 1.6 }}>
            Références : Oswald Bold, Bebas Neue, Barlow Condensed Bold.
            Nerveuse, dynamique, lisible. Utilisée pour les accroches,
            les noms de classes, les titres de sections.
          </p>
        </div>
        <div style={{ background: "#141420", borderRadius: 12, padding: 24 }}>
          <span style={{ fontSize: 11, color: "#4080ff", letterSpacing: 2 }}>CORPS / UI</span>
          <div style={{ fontSize: 16, fontWeight: 400, fontFamily: "sans-serif", marginTop: 12, color: "#fff" }}>
            Clean sans-serif lisible
          </div>
          <p style={{ color: "#777", fontSize: 12, marginTop: 12, lineHeight: 1.6 }}>
            Références : Inter, DM Sans, Plus Jakarta Sans.
            Propre, moderne, haute lisibilité sur fond sombre.
            Contraste maximal avec les titres circus pour créer la tension visuelle.
          </p>
        </div>
      </div>
      ...
      <div style={{ marginTop: 32, background: "linear-gradient(135deg, #0c0c14, #1a0a20)", borderRadius: 16, padding: 32, textAlign: "center", border: "1px solid #2a2a3a" }}>
        ...
        <div style={{ fontSize: 52, fontWeight: 900, fontFamily: "'Impact', 'Arial Black', sans-serif", textTransform: "uppercase", letterSpacing: 4, margin: "8px 0", color: "#f0e8d8", textShadow: "0 0 40px rgba(200,64,216,0.3)" }}>
          CACHE CACHE KILLER
        </div>
        <div style={{ fontSize: 18, fontWeight: 600, fontFamily: "sans-serif", color: "#c840d8", fontStyle: "italic", letterSpacing: 2 }}>
          LE CIRQUE NE FERME JAMAIS.
        </div>
        <div style={{ fontSize: 14, fontFamily: "sans-serif", color: "#888", marginTop: 16 }}>
          Réservez votre session · Survivants vs Tueurs · De 3 à 10 joueurs
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24, marginBottom: 40 }}>
        <MoodCard
          title="🎪 Décor : Le Cirque de Minuit"
          items={[
            "Chapiteaux rayés rouge & noir (pas des couloirs d'hôpital)",
            "Guirlandes lumineuses, ampoules nues, néons qui clignotent",
            "Affiches vintage de \"freakshow\" avec vos personnages",
            "Confettis, serpentins, ballons dégonflés au sol",
            "Manèges figés, attractions détraquées en arrière-plan",
            "Rayures de cirque (rouge/noir, bleu/noir) comme motif récurrent",
          ]}
        />
        <MoodCard
          title="🎭 Personnages : Performers, pas Monstres"
          items={[
            "Les Tueurs sont des artistes de cirque corrompus : clown, acrobate, magicien, dompteur",
            "Ils ont du charisme, une signature visuelle forte (comme les Killers de Dead by Daylight)",
            "Les Survivants portent des tenues de spectateurs/stagiaires du cirque",
            "Chaque classe a un costume iconique, reconnaissable en silhouette",
            "Les masques des Tueurs sont expressifs : sourires figés, maquillages outranciers",
            "Style plus cartoon/stylisé que réaliste — accessible, mémorable",
          ]}
        />
        <MoodCard
          title="✨ Effets Visuels & Textures"
          items={[
            "Fumées colorées (GARDÉES) : bleu survivants, rouge tueurs, violet mystère",
            "Confettis et paillettes dans les visuels (même en 2D)",
            "Effets néon, lueurs chaudes, halos lumineux",
            "Textures : vieux bois peint, toile de chapiteau, métal rouillé de manège",
            "Étoiles, losanges, motifs de cartes à jouer",
            "Grain vintage / affiche usée (mais pas trop — rester net et moderne)",
          ]}
        />
        <MoodCard
          title="🎬 Ton & Atmosphère"
          items={[
            "\"Bienvenue au plus grand spectacle de votre vie… et peut-être le dernier.\"",
            "Le Maître de Cérémonie s'adresse au public avec ironie et panache",
            "Annonces façon fête foraine : \"Mesdames, Messieurs, la chasse commence !\"",
            "Musique : orgue de Barbarie + synthwave / beats électro sombres",
            "Le ton est JOUEUR : on taquine, on défie, on provoque avec le sourire",
            "Jamais gore, jamais trash — toujours du spectacle",
          ]}
        />
      </div>
  ...
  return (
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 24, marginBottom: 40 }}>
        <Card accent="#e84040" title="Piste 1 : Le Chapiteau">
          ...
          <p style={{ fontSize: 12, color: "#888", lineHeight: 1.6 }}>
            Le monogramme CCK dans un cadre inspiré d'un fronton de chapiteau.
            Étoiles décoratives, rayures en fond.
            Version compacte pour les réseaux, version longue pour le site.
          </p>
        </Card>
        ...
        <Card accent="#c840d8" title="Piste 2 : Le Ticket d'Entrée">
          ...
          <p style={{ fontSize: 12, color: "#888", lineHeight: 1.6 }}>
            Le logo comme un ticket de spectacle / billet d'entrée.
            Renforce l'idée d'événement, de spectacle.
            "ADMIT ONE" / "ENTRÉE" en petites capitales.
          </p>
        </Card>
        ...
        <Card accent="#f0a030" title="Piste 3 : La Mascotte">
          ...
          <p style={{ fontSize: 12, color: "#888", lineHeight: 1.6 }}>
            Un personnage iconique (le Maître de Cérémonie / un clown stylisé)
            intégré au logo. Crée de l'attachement, du merch, une mascotte reconnaissable.
            Pensez au Freddy de FNAF, au Joker.
          </p>
        </Card>
      </div>
      ...
      <div style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
        {[
          "★ Étoiles (motif cirque)",
          "◆ Losanges (motif arlequin)",
          "⚡ Éclairs (action, énergie)",
          "🎪 Chapiteau (cadre, icône)",
          "🎟️ Ticket (CTA, réservation)",
          "🃏 Cartes à jouer (personnages)",
          "↺ Spirales (hypnose, mystère)",
          "✂ Rayures (tentes, costumes)",
        ].map((e) => (
    ...
    <div>
        ...
        <Card accent="#40c8a0" title="Écran Classement (in-situ)">
          <div style={{ background: "#0c0c14", borderRadius: 8, padding: 20, border: "1px solid #2a2a3a", marginTop: 12 }}>
            <div style={{ textAlign: "center", marginBottom: 12 }}>
              <span style={{ fontSize: 10, letterSpacing: 3, color: "#f0a030" }}>🏆 CLASSEMENT DU MOIS 🏆</span>
            </div>
            {[
              { rank: "🥇", name: "DarkJ0ker", score: 2840, color: "#f0a030" },
              { rank: "🥈", name: "SurvivorQueen", score: 2650, color: "#ccc" },
              { rank: "🥉", name: "NightRunner", score: 2410, color: "#c87830" },
            ].map((p) => (
      ...
      <div style={{ background: "#141420", borderRadius: 16, padding: 24, border: "1px solid #2a2a3a" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 20 }}>
          {[
            { step: "1", title: "Valider la direction", desc: "Confirmer les principes du mood board avec l'équipe. Ajuster les curseurs fun/peur.", color: "#f0a030" },
            { step: "2", title: "Créer le nouveau logo", desc: "Briefer un graphiste ou itérer avec IA sur les 3 pistes proposées. Tester en contexte.", color: "#c840d8" },
            { step: "3", title: "Décliner la charte", desc: "Typographies finales, iconographie, motifs, templates réseaux, kit UI pour les plateformes.", color: "#4080ff" },
          ].map((s) => (
